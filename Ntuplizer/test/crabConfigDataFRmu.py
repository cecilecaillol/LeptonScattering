...
config.General.workArea = 'crab_projectsFRmu'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'run_frmu_2018data_cfg.py'
...
config.Data.outLFNDirBase = '/store/group/cmst3/user/ccaillol/LeptonScattering/FRmu/'

...
#config.General.requestName = 'MuonEG_2016postF'
#config.General.requestName = 'MuonEG_2016postG'
#config.General.requestName = 'MuonEG_2016postH'
...
#config.General.requestName = 'DoubleMuon_2016postF'
#config.General.requestName = 'DoubleMuon_2016postG'
config.General.requestName = 'DoubleMuon_2016postH'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'run_ssem_2016postdata_cfg.py'
config.JobType.allowUndistributedCMSSW = True

#config.Data.inputDataset = "/MuonEG/Run2016F-UL2016_MiniAODv2-v2/MINIAOD"
#config.Data.inputDataset = "/MuonEG/Run2016G-UL2016_MiniAODv2-v2/MINIAOD"
#config.Data.inputDataset = "/MuonEG/Run2016H-UL2016_MiniAODv2-v2/MINIAOD"

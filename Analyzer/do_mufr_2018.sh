...
./FinalSelection_mufr_from3mu.exe 2018 /eos/cms/store/group/cmst3/user/ccaillol/LeptonScattering/FR/DoubleMuon.root output_mufr_2018/Data.root data_obs data_obs
